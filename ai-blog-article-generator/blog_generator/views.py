...
def generate_blog_from_transcription(transcription):
    ...
    prompt = f"Based on the following transcript from a YouTube video, write a detailed and descriptive summary, write it based on the transcript, but dont make it look like a youtube video, make it look like a proper summary. Write plain text with no special formatting. :\n\n{transcription}\n\nArticle:"
